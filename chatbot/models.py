...
class ChatbotConversation(models.Model):
    ...
    title = models.CharField(max_length=255, blank=True, help_text="Title of the conversation")
...
class ChatMessage(models.Model):
    ...
    def __str__(self):
        sender = "Bot" if self.is_bot else (self.sender.username if self.sender else "Unknown")
...
class ConversationSummary(models.Model):
    ...
    conversation_id = models.CharField(max_length=255, help_text="ID of the conversation")
    user = models.ForeignKey(
        settings.AUTH_USER_MODEL,
        on_delete=models.CASCADE,
