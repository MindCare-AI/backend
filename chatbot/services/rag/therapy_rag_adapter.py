...
class TherapyRAGAdapter:
    ...
    def get_therapy_approach(self, query: str, user_data: Dict = None) -> Dict[str, Any]:
        ...
        try:
            ...
            therapy_type, confidence, supporting_chunks = self.vector_store.determine_therapy_approach(query)

            # Get relevant techniques based on the determined approach
            techniques = self._get_techniques_for_approach(therapy_type, supporting_chunks)
            ...
            result = {
                ...
                "supporting_evidence": [chunk.get("text", "")[:200] + "..." for chunk in supporting_chunks[:3]],
                "alternative_approach": alternative,
                "supporting_chunks": supporting_chunks
            }

            logger.info(f"RAG recommendation: {therapy_type} (confidence: {confidence:.2f})")
            return result
    ...
    def _get_techniques_for_approach(self, therapy_type: str, chunks: List[Dict]) -> List[Dict]:
        ...
        cbt_techniques = [
            ...
            {"name": "Behavioral Activation", "description": "Increase engagement in meaningful activities"},
            {"name": "Thought Records", "description": "Track and analyze thoughts and emotions"},
            {"name": "Problem Solving", "description": "Systematic approach to addressing challenges"}
        ]
        
        # Common DBT techniques  
        dbt_techniques = [
            {"name": "Mindfulness", "description": "Present-moment awareness and acceptance"},
            {"name": "Distress Tolerance", "description": "Skills to cope with crisis situations"},
            {"name": "Emotion Regulation", "description": "Understanding and managing emotions"},
            {"name": "Interpersonal Effectiveness", "description": "Skills for healthy relationships"}
        ]
        ...
        if therapy_type == "cbt":
            ...
            techniques = [
                {"name": "Mindful Breathing", "description": "Simple breathing exercises for relaxation"},
                {"name": "Journaling", "description": "Write down thoughts and feelings"}
            ]
    ...
    def search_similar_content(self, query: str, therapy_type: str = None, limit: int = 5) -> List[Dict]:
