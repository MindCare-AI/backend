...
def answer_therapy_question(question: str) -> Dict[str, Any]:
    ...
    try:
        ...
        response = _generate_therapy_response_with_context(question, context, therapy_type)
...
def _generate_therapy_response_with_context(question: str, context: str, therapy_type: str) -> str:
...
def _create_general_support_response(question: str) -> Dict[str, Any]:
    ...
    if any(word in question_lower for word in ["anxiety", "anxious", "worried", "stress"]):
        content = (
    ...
    elif any(word in question_lower for word in ["depression", "depressed", "sad", "down"]):
        content = (
    ...
    elif any(word in question_lower for word in ["relationship", "partner", "friend", "family"]):
        content = (
