...
class DataCollectionRunSerializer(serializers.ModelSerializer):
    ...
    def get_success_rate(self, obj):
        if obj.records_processed > 0:
            success_rate = (
                (obj.records_processed - obj.errors_count) / obj.records_processed
            ) * 100
...
class CommunicationMetricsSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "therapist_conversations",
            "peer_conversations",
            "support_seeking_score",
            "support_giving_score",
...
class DataQualityReportSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
            ...
            "report_date",
            "total_users",
            "users_with_mood_data",
            "users_with_journal_data",
            "users_with_communication_data",
            "data_completeness_score",
    ...
    def get_total_users(self, obj):
        ...
        return max(
            obj.users_with_mood_data,
            obj.users_with_journal_data,
            obj.users_with_communication_data,
        )
