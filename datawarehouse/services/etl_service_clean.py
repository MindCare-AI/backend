...
class ETLService:
    ...
    def _process_user_data(self, user: User, since: Optional[datetime] = None) -> Dict[str, Any]:
        """
    ...
    def _transform_user_data(self, df: pd.DataFrame, user: User) -> pd.DataFrame:
        """
    ...
    def _create_user_snapshot(self, user: User, transformed_data: pd.DataFrame) -> Optional[UserDataSnapshot]:
        """
    ...
    def _find_recently_active_users(self, since: datetime) -> List[User]:
        """
        Find users with recent activity
