...
journal_category_list = JournalCategoryViewSet.as_view({"get": "list", "post": "create"})
...
urlpatterns = [
    ...
    path("categories/<int:pk>/", journal_category_detail, name="journal-category-detail"),
    path("categories/<int:pk>/entries/", journal_category_entries, name="journal-category-entries"),
    ...
    path("entries/share/<str:journal_id>/", JournalEntryViewSet.as_view({"post": "share"}), name="journal-entry-share"),
    path("entries/statistics/", JournalEntryViewSet.as_view({"get": "statistics"}), name="journal-entry-statistics"),
]
