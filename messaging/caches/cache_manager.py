...
class MessagingCacheManager:
    ...
    def __init__(self):
        ...
        self.default_timeout = getattr(settings, 'MESSAGING_CACHE_TIMEOUT', 3600)  # 1 hour
    ...
    def set_message(self, message_id: str, data: Dict, timeout: Optional[int] = None) -> None:
    ...
    def set_conversation_messages(self, conversation_id: str, messages: List[Dict], 
    ...
    def set_user_conversations(self, user_id: str, conversation_ids: List[str],
                             timeout: Optional[int] = None) -> None:
    ...
    def set_conversation_participants(self, conversation_id: str, participant_ids: List[str],
                                   timeout: Optional[int] = None) -> None:
    ...
    def add_message_reaction(self, message_id: str, user_id: str, reaction: str) -> None:
    ...
    def remove_message_reaction(self, message_id: str, user_id: str, reaction: str) -> None:
    ...
    def set_user_typing(self, conversation_id: str, user_id: str, 
                       is_typing: bool, timeout: int = 30) -> None:
