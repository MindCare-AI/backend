...
class AllConversationsView(APIView):
    ...
    def get(self, request):
        ...
        one_to_one_data = OneToOneConversationSerializer(one_to_one, many=True, context={'request': request}).data
        groups_data = GroupConversationSerializer(groups, many=True, context={'request': request}).data
