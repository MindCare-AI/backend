...
class DayTimeSlotField(serializers.DictField):
    ...
    def to_internal_value(self, data):
        ...
        if not isinstance(data, dict):
            raise serializers.ValidationError("Available days must be provided as a dictionary")
...
class TherapistAvailabilitySerializer(serializers.ModelSerializer):
    ...
    def to_internal_value(self, data):
        ...
        if isinstance(data, dict) and 'available_days' in data and isinstance(data['available_days'], str):
            try:
