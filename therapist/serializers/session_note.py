...
class SessionNoteSerializer(serializers.ModelSerializer):
    ...
    def validate(self, attrs):
        ...
        if attrs.get('appointment'):
            ...
            if attrs.get('session_date') and attrs['session_date'] != attrs['appointment'].appointment_date.date():
        ...
        elif attrs.get('session_date') and attrs['session_date'] > datetime.now().date():
            raise serializers.ValidationError(
